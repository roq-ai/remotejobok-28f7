...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'job.create': { roles: ['business-owner'], key: 'new-job-posted', tenantPath: ['company', 'job'], userPath: [] },
  'bid.create': {
    roles: ['business-owner'],
    key: 'new-bid-received',
    tenantPath: ['company', 'job', 'bid'],
    userPath: [],
  },
  'review.create': {
    roles: ['business-owner'],
    key: 'new-review-posted',
    tenantPath: ['company', 'job', 'review'],
    userPath: [],
  },
};
