...
export function ReviewListPage(props: ReviewListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getReviews({
        relations: ['user_review_user_idTouser', 'job', 'user_review_reviewee_idTouser'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'user_review_user_idTouser',
          header: 'User Review User Id Touser',
          accessorKey: 'user_review_user_idTouser',
          cell: ({ row: { original: record } }: any) => (
            <Link
              as={NextLink}
              onClick={(e) => e.stopPropagation()}
              href={`/users/view/${record.user_review_user_idTouser?.id}`}
            >
              {record.user_review_user_idTouser?.email}
            </Link>
          ),
        }
      : null,
