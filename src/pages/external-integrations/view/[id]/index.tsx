...
import { getExternalIntegrationById } from 'apiSdk/external-integrations';
import { ExternalIntegrationInterface } from 'interfaces/external-integration';

function ExternalIntegrationViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'External Integration Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('external_integration', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/external-integrations/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Api Key" text={data?.api_key} />

                <FormListItem label="Api Secret" text={data?.api_secret} />
